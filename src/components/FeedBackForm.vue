<template>
  <PopupWrapper v-if="show" @click="close">
    <div class="feedback-form" @click.stop>
      ...
      <input type="text" placeholder="Как к вам обращаться?" v-model="data.fio">
      <input type="email" placeholder="E-mail" v-model="data.email">
      <textarea maxlength="300" placeholder="Комментарий (до 300 символов)" v-model="data.comment"></textarea>
